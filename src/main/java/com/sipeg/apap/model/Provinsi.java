...
public class Provinsi {
    @Id
    @TableGenerator(name = "provinsiGen", initialValue = 95)
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "provinsiGen")
    ...
    public List<Instansi> getInstansiPegawai() {
